...
def main():
    print("=" * 76)
    print(" OASIS v6.2.0 CONSULTATION AUDIO STORAGE UPDATE")
    print("=" * 76)
    ...
    print("[SUCCESS] v6.2.0 update completed.")
    print("Run supabase_v620_upgrade.sql in Supabase SQL Editor.")
