...
def main():
    print("=" * 68)
    print(" OASIS v4.4.0 CRM HISTORY ADDRESS UPDATE")
    print("=" * 68)
    ...
    backup = ROOT / "_oasis_backups" / (
        datetime.now().strftime("%Y%m%d_%H%M%S") + "_before_v440"
    )
    ...
    print("[SUCCESS] v4.4.0 update completed.")
    print("Run supabase_v440_upgrade.sql in Supabase SQL Editor.")
