...
FILES = ("app.py", "utils.py", "VERSION.txt", "CHANGELOG_v3.5.4.md")
...
def main():
    print("=" * 62)
    print(" OASIS v3.5.4 CRETOP STABILITY UPDATE")
    print("=" * 62)
    ...
    backup = BACKUP_ROOT / f"{datetime.now().strftime('%Y%m%d_%H%M%S')}_before_v354"
