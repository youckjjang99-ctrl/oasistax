...
def make_basic_customer_template_bytes():
    customer_columns = [
        ...
        "주업종코드", "필요경비", "사업소득금액", "각사업연도소득금액",
        "영업손익", "표준손익계산서매출액", "표준손익계산서당기순손익",
        "과세기간시작일", "과세기간종료일", "소득률", "필요경비율",
...
def build_customer_row_from_cretop(data, columns=None):
    ...
    alias_map = {
        ...
        "필요경비": ["필요경비"],
        "사업소득금액": ["사업소득금액"],
        "각사업연도소득금액": ["각사업연도소득금액", "사업소득금액"],
        "영업손익": ["영업손익", "영업이익"],
        "표준손익계산서매출액": ["표준손익계산서매출액"],
        "표준손익계산서당기순손익": ["표준손익계산서당기순손익"],
        "과세기간시작일": ["과세기간시작일"],
        "과세기간종료일": ["과세기간종료일"],
        "소득률": ["소득률"],
        "필요경비율": ["필요경비율"],
