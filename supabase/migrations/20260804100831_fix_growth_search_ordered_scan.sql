...
-- optimization fence. Narrow industry and single-channel searches retain the
-- existing plan so their partial indexes remain available to the planner.
...
declare
    ...
    use_ordered_scan boolean := (
        ...
        and coalesce(cardinality(p_industries), 0) = 0
