...
def main() -> int:
    print("=" * 62)
    print(" OASIS v3.5.2 DUPLICATE CUSTOMER PREVENTION UPDATE")
    print("=" * 62)
    ...
    backup = BACKUP_ROOT / f"{datetime.now().strftime('%Y%m%d_%H%M%S')}_before_v352"
    ...
    print("[SUCCESS] v3.5.2 업데이트가 완료되었습니다.")
    print("동일 사업자등록번호는 누적 고객DB에 추가되지 않습니다.")
